...
// const rows = this.props.data.anomalies.map((anomaly) => {
//   let symbol = '▲';
//   if (anomaly.Type == -1) {
//     symbol = '▼';
//   }
//   return {...anomaly, Type: symbol}
// });

// const rows = AnomalyData.anomalies.map((anomaly) => {
//   let symbol = '▲';
//   if (anomaly.Type == -1) {
//     symbol = '▼';
//   }
...
export default function ReactVirtualizedTable(props) {
  // console.log(props.data.anomalies);
  let rows = [];
  if(props.data) {
